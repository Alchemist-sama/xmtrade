    ...
    return ( 
        <div className="bg-gradient-to-tl from-blue-900 to-black pb-10 px-28 max-[610px]:px-20 max-[472px]:px-10 max-[390px]:px-5 pt-20 text-black">{/*pl-64*/ }
            ...
            <div className='text-white mt-20 flex  max-[715px]:flex-col  gap-40 max-[860px]:gap-20 max-[775px]:gap-10 max-[970px]:justify-center items-center'>
                <div>
                    <h3 className='text-4xl mb-5 font-serif'>Invest with XMTRADE today!!!</h3>
                    <p className='w-[500px] max-[715px]:w-full leading-loose text-sm max-[775px]:text-[13px] text-slate-300'>Are you looking for a way to invest in the future of finance? If so, then Join us at XMTRADE. We offer a wide variety of plans to choose from, as well as high returns and a user-friendly interface.
                    ...
                    So what are you waiting for? Join XMTRADE today and start investing in the future!</p>
