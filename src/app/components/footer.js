...
const Footer = () => {
    return ( 
        <div className="bg-gradient-to-tl from-blue-900 to-black text-white flex flex-col items-center pb-5">
            <div className="flex  justify-between  p-20  max-[720px]:p-10 max-[680px]:px-5  text-white text-sm w-full max-[610px]:flex-col w-full">
                ...
                <div className="flex items-center">
                    <img
                        ...
                        className='w-16'
                    />
                    <p className="text-2xl font-serif">xmtrade</p>
                </div>
                </Link>
                ...
                <div>
                    ...
                    <p className="text-[12px] mt-7 max-[450px]:mt-4">xmtrade@gmail.com</p>
                </div>
            ...
            <p className='flex items-center max-[450px]:text-[13px]'><AiOutlineCopyright /> 2022 XMTRADE. All rights reserved</p>
        </div>
