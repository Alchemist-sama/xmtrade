...
const Body = () => {
    ...
    return ( 
        <div className="bg-white text-black mt-24 max-[875px]:mt-10 max-[720px]:mt-5  flex flex-col items-center justify-center px-28 max-[875px]:px-10  gap-5 pt-20">
            <h3 className="text-2xl" data-aos="fade-zoom-in">What is xmtrade?</h3>
            <p className="text-center text-sm leading-loose text-slate-500" data-aos="fade-zoom-in">
                xmtrade is a team of wholesale investors, analysts and programmers. We have been working on cryptocurrency platforms (and not only) for more than 4 years and have a competitive portfolio. All meetings, communications and agreements with our partners (clients) are held in a transparent manner.
            </p>
            ...
            <div className="flex gap-20 max-[450px]:flex-col" data-aos="fade-zoom-in">
                <div className="flex flex-col items-center justify-center gap-2">
                    ...
                    <p className="text-[12px] text-slate-400 text-center min-[450px]:hidden">xmtrade is committed to transparency. We believe that it is important to be open and honest with our customers, employees, and other stakeholders. We believe that transparency builds trust and allows us to build stronger relationships.</p>
                </div>
                <div className="flex flex-col items-center justify-center gap-2">
            ...
            <div className="flex max-[660px]:flex-col  justify-between gap-20  max-[720px]:gap-10 mt-20 overflow-hidden">
                <div className="w-1/2 max-[660px]:w-full flex flex-col gap-5" data-aos="slide-right">
                    <h3 className="text-4xl font-serif">Here at xmtrade,<br/> We are all about security!</h3>
