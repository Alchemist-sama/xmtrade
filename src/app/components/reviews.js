      ...
      >
        <SwiperSlide>
         <div className='flex flex-col items-center bg-blue-900 text-white py-5 rounded-2xl h-[400px]'>
             ...
             <p className='text-sm w-52 mt-5 leading-loose'><span className='text-3xl'>" </span> I've been using XMTRADE for a few months now and I'm really impressed with the results. I've been able to make a lot of money with their crypto investment platform and they helped get most of the things i wanted this year, highly recommend. <span className='text-3xl'>"</span></p>
         </div>
        </SwiperSlide>
        <SwiperSlide>
        <div className='flex flex-col items-center bg-blue-900 text-white py-5 rounded-2xl h-[400px]'>
             ...
             <p className='text-sm w-52 mt-5 leading-loose'><span className='text-3xl'>" </span> I'm a beginner to crypto investing and I was really nervous about getting started. But XMTRADE made it really easy for me to get started and their educational resources were really helpful. I'm now making a profit and I'm really happy with their service. <span className='text-3xl'>"</span></p>
         </div>
        </SwiperSlide>
        <SwiperSlide>
            <div className='flex flex-col items-center bg-blue-900 text-white py-5 rounded-2xl h-[400px]'>
                ...
                <p className='text-sm w-52 mt-5 leading-loose'><span className='text-3xl'>" </span> I've been using XMTRADE for a year now and I've been really happy with the results. They have a great track record of success and their customer service is always there to help. I would definitely recommend XMTRADE to anyone who is looking to invest in crypto <span className='text-3xl'>"</span></p>
            </div>
        </SwiperSlide>
        <SwiperSlide>
            <div className='flex flex-col items-center bg-blue-900 text-white py-5 rounded-2xl h-[400px]'>
                ...
                <p className='text-sm w-52 mt-5 leading-loose'><span className='text-3xl'>" </span>XMTRADE has helped me to achieve my financial goals. They are professional and knowledgeable and they always put my needs first <span className='text-3xl'>"</span></p>
            </div>
        </SwiperSlide>
        <SwiperSlide>
            <div className='flex flex-col items-center bg-blue-900 text-white py-5 rounded-2xl h-[400px]'>
        ...
        <SwiperSlide>
            <div className='flex flex-col items-center bg-blue-900 text-white py-5 rounded-2xl h-[400px]'>
                ...
                <p className='text-sm w-52 mt-5 leading-loose'><span className='text-3xl'>" </span>Investing with XMTRADE was scary at first but i made us my mind to try and that is the best decision i ever made. <span className='text-3xl'>"</span></p>
            </div>
        </SwiperSlide>
        <SwiperSlide>
            <div className='flex flex-col items-center bg-blue-900 text-white py-5 rounded-2xl h-[400px]'>
                ...
                <p className='text-sm w-52 mt-5 leading-loose'><span className='text-3xl'>" </span>Shoutout to XMTRADE for helping me make my first 500k, I look forward to investing more with XMTRADE <span className='text-3xl'>"</span></p>
            </div>
        </SwiperSlide>
      </Swiper>
    </>
