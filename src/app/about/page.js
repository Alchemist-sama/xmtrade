        ...
        <div className="bg-gradient-to-tl from-blue-900 to-black pb-10 px-28 max-[650px]:px-20 max-[550px]:px-10 pt-28">
            <div className=" flex max-[950px]:flex-col justify-center gap-5">
                ...
                <p className="text-[13px] mb-5 leading-loose">
                    Welcome to xmtrade, your one-stop platform for cryptocurrency investment. We are a team of experienced investors and analysts who are passionate about helping people invest in and profit from the crypto market.
                    ...
                    Our goal at xmtrade is to help you make successful crypto investments without prior knowledge of crypto, to avoid loosing your savings to the crypto market which can be quite volatile.
                </p>
            ...
            <div className="flex max-[550px]:flex-col gap-5 text-white mx-5 mb-10">
                ...
                <div className="w-[500px] max-[550px]:w-full">
                    ...
                    Thank you for visiting xmtrade!</p>
                </div>
            </div>
            <div>
